...
class PradeepKumarSahityaScreen extends StatefulWidget {
  const PradeepKumarSahityaScreen({super.key});

  @override
  State<PradeepKumarSahityaScreen> createState() => _PradeepKumarSahityaScreenState();
}

class _PradeepKumarSahityaScreenState extends State<PradeepKumarSahityaScreen> {
  bool _loading = true;
  bool _error = false;
  List<dynamic> _data = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse('https://website.sadhumargi.in/api/aavedan-patra/pradeep_rampuria_award'),
      );
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('प्रदीप कुमार साहित्य पुरस्कार आवेदन-पत्र',
