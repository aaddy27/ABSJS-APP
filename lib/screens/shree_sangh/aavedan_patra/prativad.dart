...
class PrativadScreen extends StatefulWidget {
  const PrativadScreen({super.key});

  @override
  State<PrativadScreen> createState() => _PrativadScreenState();
}

class _PrativadScreenState extends State<PrativadScreen> {
  bool _loading = true;
  bool _error = false;
  List<dynamic> _data = [];
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color.fromARGB(255, 56, 114, 153), Color.fromARGB(255, 48, 98, 163)],
                    ...
                    return SliverGrid(
                      ...
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          ...
                          return _PrativadCard(
                            title: item['name'] ?? '',
                            subtitle: item['description'] ?? '',
                            file: item['file'] ?? '',
                            fileType: (item['file_type'] ?? 'pdf').toString(),
                            color: const Color.fromARGB(255, 49, 86, 129),
...
class _PrativadCard extends StatelessWidget {
  final String title;
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: fileType.toLowerCase() == 'pdf' ? color : color.withOpacity(0.12),
              width: fileType.toLowerCase() == 'pdf' ? 2 : 1,
            ),
          ),
          child: Row(
            children: [
