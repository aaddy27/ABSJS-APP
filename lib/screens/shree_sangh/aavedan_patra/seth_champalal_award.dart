...
class SethChampalalAwardScreen extends StatefulWidget {
  const SethChampalalAwardScreen({super.key});

  @override
  State<SethChampalalAwardScreen> createState() => _SethChampalalAwardScreenState();
}

class _SethChampalalAwardScreenState extends State<SethChampalalAwardScreen> {
  bool _loading = true;
  bool _error = false;
  List<dynamic> _data = [];
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse('https://website.sadhumargi.in/api/aavedan-patra/champalal_award'),
      );
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('सेठ श्री चम्पालाल पुरस्कार आवेदन-पत्र',
