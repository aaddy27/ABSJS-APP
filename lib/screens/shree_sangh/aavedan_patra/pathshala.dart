...
class PathshalaScreen extends StatefulWidget {
  const PathshalaScreen({super.key});

  @override
  State<PathshalaScreen> createState() => _PathshalaScreenState();
}

class _PathshalaScreenState extends State<PathshalaScreen> {
  bool _loading = true;
  List<dynamic> _forms = [];
  ...
  Future<void> _fetchForms() async {
    try {
      final response = await http.get(
        Uri.parse('https://website.sadhumargi.in/api/aavedan-patra/pathshala'),
      );
