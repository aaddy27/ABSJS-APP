...
class YuvaSanghNotificationsScreen extends StatefulWidget {
  const YuvaSanghNotificationsScreen({super.key});

  @override
  State<YuvaSanghNotificationsScreen> createState() => _YuvaSanghNotificationsScreenState();
}

class _YuvaSanghNotificationsScreenState extends State<YuvaSanghNotificationsScreen> {
  List notifications = [];
  bool isLoading = true;
  ...
  Future<void> fetchNotifications() async {
    try {
      final response = await http.get(
        Uri.parse("https://website.sadhumargi.in/api/notifications/filter?group=Yuva%20Sangh"),
      );
